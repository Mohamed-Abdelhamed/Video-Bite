        ...
        for i, distance in enumerate(distances):
            if distance < threshold:
                ...
                encoding_edges.append(
                    (node_id, edge_id, {'weight': (1-distance)}))
...
def cluster_facial_encodings(facial_encodings):
    ...
    sorted_clusters = _chinese_whispers(
        facial_encodings.items(), threshold=0.50, iterations=15)
    return sorted_clusters
...
def save(facial_encodings):
    ...
    # print("byeeeeeeeeeeeeeeeee byeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee fadyyyyyyyyyyyyyyyyyyyyyy")
    answer = cluster_facial_encodings(facial_encodings)
    try:
        shutil.rmtree(result_dir, ignore_errors=True)
        os.mkdir(result_dir)
        #os.system("sudo mkdir "+result_dir)
    except:
        os.mkdir(result_dir)
        #os.system("sudo mkdir "+result_dir)
