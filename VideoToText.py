...
video_path = '/home/mark/Downloads/S2VT-master/videos/' #Videos Folder .avi
videos_npy_path = "/home/mark/Downloads/S2VT-master/videos/output/" #Videos npy Folder .avi.npy
...
class VideoToText:
    ...
    def extractText(self):
        ...
        for video in self.videos:
            featureExtraction(video).extractFeatures()
            video_feat = np.load(videos_npy_path + video + ".npy")
...
num_frames = 80
vgg_model = '/home/mark/Downloads/S2VT-master/models/vgg/VGG_ILSVRC_19_layers.caffemodel'
vgg_deploy = '/home/mark/Downloads/S2VT-master/models/vgg/VGG_ILSVRC_19_layers_deploy.prototxt'
mean = '/home/mark/Downloads/S2VT-master/models/vgg/ilsvrc_2012_mean.npy'
...
class featureExtraction():
    ...
    def extractFeatures(self):
        ...
        video_fullpath = video_path + self.video
